...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void FlightController::gps_setup(void)
{
...
void FlightController::read_gps(void)
{
  ...
  { // If there is a new set of GPS data available.
    if (number_used_sats < 8)
      ...
      digitalWrite(STM32_board_LED, LOW); // Turn the LED on the STM solid on (LED function is inverted). Check the STM32 schematic.
  ...
  if (gps_watchdog_timer + 1000 < millis())
