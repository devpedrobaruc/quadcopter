...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void FlightController::red_led(int8_t level)
{
  if (flip32)
...
{
  if (flip32)
    digitalWrite(PB3, !level); // If a Flip32 is used invert the output.
  else
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void FlightController::error_signal(void)
{
  if (error >= 100)
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void FlightController::flight_mode_signal(void)
{
